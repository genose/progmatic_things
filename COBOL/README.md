...
![Platform macOS](https://img.shields.io/badge/platform-macOS%20%2F%20Linux%20%2F%20WSL-black)
![GnuCOBOL](https://img.shields.io/badge/GnuCOBOL-3.2-success)
![MVS TK5](https://img.shields.io/badge/MVS-TK5%20%2F%20Hercules-blue)
![CICS](https://img.shields.io/badge/CICS-KICKS%20v1.5%20%2F%20CICS%2FVS%201.7-orange)
![Java 8](https://img.shields.io/badge/Java-8%20TDD-red)
![Tests](https://img.shields.io/badge/tests-174%20passing-brightgreen)

**Auteur :** Sebastien Cotillard — exercices pédagogiques, projets mainframe COBOL et migration Java.
...
- **Backend CICS** : KICKS v1.5.0 (par défaut) ou CICS/VS 1.7
...
| --------------- | ---- | ---------- |
| `D05_VERIF_CRM.SCO` | Synchronisation commandes DEPOT ↔ CRM | 29 tests |
| `T10_MAJ_DTLIVR_BDCRM.COB` | Mise à jour dates livraison DTLIVR | 11 tests |
| `D02_EXTCDE_CRMCSP1.COB` | Génération fichiers confirmation CSP (197 chars) | 75 tests |
| `D05_INTCDEFAC_CRM_V2.SCO` | UPSERT CDEFAC → BD_CRM.S.CDE_FAC | 59 tests |

**Total : 174 tests — 0 échec** · 18 classes de tests · TDD B-codes tracés
...
#### Backend CICS — choix assisté

| Backend | Mode | Ressources | Installation |
| ------- | ---- | ---------- | ------------ |
| **KICKS v1.5.0** | TSO (pas de STC) | CEDA/CEMT interactif | `bash mvs/12_kicks_install.sh all` (~30 min) |
| **CICS/VS 1.7** | VTAM region (STC) | Tables assemblées (PCT/PPT/TCT/FCT) | `bash mvs/13_cicsvs_install.sh all` (plusieurs jours, bitsavers.org) |
| **Les deux** | Auto-dispatch | — | `CICS_BACKEND=both` |

```bash
# Détection automatique du backend installé
bash CI_CD_TK5/mvs/03_cics.sh detect

# Forcer un backend
CICS_BACKEND=cicsvs bash CI_CD_TK5/mvs/03_cics.sh newcopy
```
