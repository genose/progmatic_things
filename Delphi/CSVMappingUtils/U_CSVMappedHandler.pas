      ...
      begin
        ...
        begin
          if (_aCSVHeaderMapping <> nil) and  ( _aCSVHeaderMapping.count >0) and ( _aCSVHeaderMapping.count >  iCurrentMapFieldIndex )  then
            iCurrentLineFieldIndex := (_aCSVHeaderMapping.MapList[iCurrentMapFieldIndex]) [TCSVMapStorageArrayValues_Definition.PropertyMapIndex.kiCSVFieldLength]// simplement la longueur du champ ....
