...
begin
  ...
  begin
    ...
    WSObjWriteDebug('Base::toString:::: aValueTemp is TWSVariant')// Result :=  TWSVariant(aValueTemp).ToString();
  //exit;

  else if aValueTemp is TWSObject then
    WSObjWriteDebug('Base::toString:::: aValueTemp is TWSObject')// Result :=  TWSVariant(aValueTemp).ToString();
  // exit;
...
begin
  ...
  begin
    ...
    WSObjWriteDebug('Base::ToStringJson:::: aValueTemp is TWSVariant')// Result :=  TWSVariant(aValueTemp).ToString();
  //exit;

  else if aValueTemp is TWSObject then
    WSObjWriteDebug('Base::ToStringJson:::: aValueTemp is TWSObject')// Result :=  TWSVariant(aValueTemp).ToString();
  // exit;
...
begin
  ...
  aValueTemp := self;
  if aValueTemp is TWSBoolean then
    WSObjWriteDebug('Base::GetCountValues:::: aValueTemp is TWSString :: REAAD :: '+TWSBoolean(aValueTemp).toString)//Result :=  integer(TWSBoolean(aValueTemp).value);
  //exit;

  else  if aValueTemp is TWSNumber then
    WSObjWriteDebug('Base::GetCountValues:::: aValueTemp is TWSString :: REAAD :: '+TWSNumber(aValueTemp).toString)//ivalue := TWSNumber(aValueTemp).value;
  //Result :=  (ivalue);
  //exit;
  ...
  begin
    ...
    WSObjWriteDebug('Base::GetCountValues:::: aValueTemp is TWSVariant')// :: Result :=  TWSVariant(aValueTemp).count;
  //exit;

  else if aValueTemp is TWSObject then
    WSObjWriteDebug('Base::GetCountValues:::: aValueTemp is TWSObject')//Result := 0;//:: TWSVariant(aValueTemp).count;
  //exit;
  ...
  begin
    ...
    begin
      ...
      if (iNbFilter >0) then 
        ...
        end//setlength(Result[indexKey], iNbFilter +1);
        ...
        begin
          ...
          case (iJsonFieldType) of
            ...
            begin
              ...
              iJsonChildKey := 0;
              for iJsonChildKey := 0 to (TlkJSONList(aObjectJsonElement).count -1) do
              begin
