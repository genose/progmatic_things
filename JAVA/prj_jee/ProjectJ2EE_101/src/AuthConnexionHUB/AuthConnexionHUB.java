...
public class AuthConnexionHUB extends HttpServlet implements Filter {
	...
	public final String AUTH_TOKEN_KEY = "userToken";
	public final String AUTH_INFO_USERNAME_KEY = "userNameToken";
	public final String AUTH_INFO_PASSWORD_KEY = "userPasswordToken";
    /* ************************************************** */
	public final String APP_CURRENT_FRONT_ORIGIN = "httpHeaderReferer";
	public final String APP_CURRENT_FRONT_ORIGIN_REQUEST_URI = "httpHeaderRefererRequestURI";
	public final String APP_CURRENT_FRONT_ORIGIN_SERVLET = "httpHeaderRefererServletOrigin";


	public final String DEFAULT_PAGE_INDEX = "_index.jsp";
	public final String DEFAULT_PAGE_AUTH_PASSED_VIEW_MYACCOUNT = "compte.jsp";
    /* ************************************************** */
	public final String DEFAULT_PAGE_AUTH_CONNEXION = "/AuthConnexionHUB";
    /* ************************************************** */

	public final String DEFAULT_PAGE_AUTH_PASSED_WELCOME = "connexionReussie.jsp";
    /* ************************************************** */
	...
	/* if (userSession != null   ) { 
        ...
        try {
            ...
            if (doAuth(oUserAuthInfo, request, response)) {
                ...
                if (userToken != null) {
                    ...
                    if (String.valueOf(requestedThruForwardAuthUri).length() <= 2) {
                        ...
                        if (String.valueOf(applicationPageHub_Referer).indexOf(".jsp") != (-1)) {
                            ...
                            consoleLog.println("C1 Got NOPE in Request :: let welcome User :: requestedThruForwardAuthUri = " + requestedThruForwardAuthUri);
                            // :: DEFAULT_PAGE_AUTH_PASSED_VIEW_MYACCOUNT;
							requestedThruForwardAuthUri = (requestedThruForwardAuthUri == null)? DEFAULT_PAGE_AUTH_PASSED_VIEW_MYACCOUNT :requestedThruForwardAuthUri;
                        }
                    ...
                    if (requestedThruForwardAuthUri == null) {
                        ...
                        return;
                    } else if ((!request.getDispatcherType().toString().contains("FORWARD"))
                            && (!request.getDispatcherType().toString().contains("INCLUDE"))
                    ) {
                    ...
                    } else if (!request.getDispatcherType().toString().contains("INCLUDE")) {
                        ...
                        try {
                            ...
                            consoleLog.println("EV_ERR_PROCESS_INCLUDE:: "+requestedThruForwardAuthUri +" :: " + EV_ERR_PROCESS_INCLUDE.getMessage());
                            response.sendError(404, "404 Error : " + URLDecoder.decode(EV_ERR_PROCESS_INCLUDE.getMessage(), "UTF-8"));
                            return;
                        }
                ...
                } else if (String.valueOf(applicationPageHub_Referer).indexOf(referepageservlet) == (-1)) {
