CREATE TABLE ACCOUNTS (idAccount INTEGER AUTO_INCREMENT NOT NULL, ACCOUNTADRESSES LONGBLOB, ACCOUNTCOMMANDES LONGBLOB, account_type INTEGER NOT NULL, CREATIONDATE DATETIME, USERINFO LONGBLOB, PRIMARY KEY (idAccount))
...
CREATE TABLE PERSONNES (ID INTEGER AUTO_INCREMENT NOT NULL, AGE INTEGER, emailidentity VARCHAR(255), named VARCHAR(255), lastname VARCHAR(255), PRIMARY KEY (ID))
...
CREATE TABLE COMMANDES (IDCOMMANDE INTEGER AUTO_INCREMENT NOT NULL, commandestatus INTEGER, ACCOUNTINFO_idAccount INTEGER, ADRESSEFACTURATION_IDADRESSE INTEGER, ADRESSELIVRAISON_IDADRESSE INTEGER, ADRESSEWAREHOUSERETURN_IDADRESSE INTEGER, PRIMARY KEY (IDCOMMANDE))
CREATE TABLE ORDER_HISTORY (ORDERHISTORYID INTEGER NOT NULL, PRIMARY KEY (ORDERHISTORYID))
CREATE TABLE WAREHOUSES_ARTICLE_POSITIONS (POSITIONID INTEGER AUTO_INCREMENT NOT NULL, POSITIONDESCRITION VARCHAR(255), POSITIONQTY INTEGER, POSITIONQTYDATE INTEGER, POSITIONQTYLASTDATE INTEGER, POSITIONREAPPROAWAIT INTEGER, POSITIONREAPPROAWAITDATE DATETIME, ARTICLESSTOCKSPOSITIONS_IDARTICLE INTEGER, PRIMARY KEY (POSITIONID))
