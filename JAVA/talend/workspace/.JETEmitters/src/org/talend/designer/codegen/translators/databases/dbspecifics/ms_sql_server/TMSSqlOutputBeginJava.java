...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_74 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  ...
  protected final String TEXT_81 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_82 = NL + "    dbschema_";
  protected final String TEXT_83 = ";";
  protected final String TEXT_84 = NL + "    String driverClass_";
  protected final String TEXT_85 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_86 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_87 = NL + "\t";
  protected final String TEXT_88 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_89 = ");" + NL + "    String port_";
  protected final String TEXT_90 = ";" + NL + "    String dbname_";
  protected final String TEXT_91 = " ;";
  protected final String TEXT_92 = NL + "    String url_";
  protected final String TEXT_93 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_94 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_95 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_96 = ")) {" + NL + "    \turl_";
  protected final String TEXT_97 = " += \":\" + ";
  protected final String TEXT_98 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_99 = ")) {";
  protected final String TEXT_100 = NL + "\t\t\t\turl_";
  protected final String TEXT_101 = " += \"//\" + ";
  protected final String TEXT_102 = "; " + NL + "\t";
  protected final String TEXT_103 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_104 = " += \";databaseName=\" + ";
  protected final String TEXT_105 = NL + "    }" + NL + "    url_";
  protected final String TEXT_106 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_140 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_151 = ".commit();";
  protected final String TEXT_152 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_153 = NL + "                              stmtCreate_";
  protected final String TEXT_154 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_172 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  ...
  protected final String TEXT_178 = NL + "                                boolean whetherExist_";
  protected final String TEXT_179 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_180 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_181 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_182 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_183 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_184 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_191 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_196 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_197 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_198 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_199 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_200 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_205 = ".equals";
  protected final String TEXT_206 = "IgnoreCase";
  protected final String TEXT_207 = "(";
  protected final String TEXT_208 = ")" + NL + "                                            && (schema_";
  protected final String TEXT_209 = "(dbschema_";
  protected final String TEXT_210 = ") || dbschema_";
  protected final String TEXT_211 = ".trim().length() ==0)) {" + NL + "                                            whetherExist_";
  protected final String TEXT_212 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_219 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_220 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_221 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_227 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_241 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_242 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_243 = ".getTables(null, conn_";
  protected final String TEXT_244 = ".getSchema(), tableForSearch_";
  protected final String TEXT_245 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_246 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_247 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_248 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_249 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_250 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_251 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_252 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_253 = ".getTables(";
  protected final String TEXT_254 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_255 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_256 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_257 = ".equalsIgnoreCase(";
  protected final String TEXT_258 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_259 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_260 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_261 = NL + "                                if(!whetherExist_";
  protected final String TEXT_262 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_268 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_273 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_279 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_280 = NL + "                              stmtClear_";
  protected final String TEXT_281 = NL + "                stmtClear_";
  protected final String TEXT_282 = ".executeUpdate(\"";
  protected final String TEXT_283 = "\");";
  protected final String TEXT_284 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_285 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_286 = NL + "                              stmtTruncCount_";
  protected final String TEXT_287 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_288 = " = stmtTruncCount_";
  protected final String TEXT_289 = ".executeQuery(\"";
  protected final String TEXT_290 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_291 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_292 = " = rsTruncCount_";
  protected final String TEXT_293 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_294 = NL + "                              stmtTrunc_";
  protected final String TEXT_295 = NL + "                conn_";
  protected final String TEXT_296 = NL + "                stmtTrunc_";
  protected final String TEXT_297 = NL + "                    if(!conn_";
  protected final String TEXT_298 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_299 = ".commit();" + NL + "                    }";
  protected final String TEXT_300 = NL + "                deletedCount_";
  protected final String TEXT_301 = " += rsTruncCountNumber_";
  protected final String TEXT_302 = ";" + NL + "            }";
  protected final String TEXT_303 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_304 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_305 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_306 = NL + "                while(rsTruncCount_";
  protected final String TEXT_307 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_308 = " += rsTruncCount_";
  protected final String TEXT_309 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_319 = " = null;" + NL + "        String keyPsmt_";
  protected final String TEXT_320 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_321 = " + \"]\";" + NL + "        pstmt_";
  protected final String TEXT_322 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_323 = ",insert_";
  protected final String TEXT_324 = ",keyPsmt_";
  ...
  protected final String TEXT_329 = "\";" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_334 = ");" + NL + "        String insert_";
  protected final String TEXT_335 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_336 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_337 = "\", pstmtInsert_";
  protected final String TEXT_338 = ");" + NL + "        String update_";
  protected final String TEXT_339 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_343 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_344 = ".prepareStatement(delete_";
  protected final String TEXT_345 = NL + NL + "    class BufferLine_";
  protected final String TEXT_346 = " {";
  protected final String TEXT_347 = " ";
  protected final String TEXT_348 = NL + NL + "        public BufferLine_";
  protected final String TEXT_349 = NL + "                    ,";
  protected final String TEXT_350 = NL + "        ){";
  protected final String TEXT_351 = NL + "                    this.";
  protected final String TEXT_352 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_353 = "> sInsertColValueList";
  protected final String TEXT_354 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_355 = " sInsertColValue";
  protected final String TEXT_356 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_357 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_358 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_359 = ".append(\"(";
  protected final String TEXT_360 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_361 = "-1) extendInsertValueStmt_";
  protected final String TEXT_362 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_363 = " = \"INSERT INTO \"+";
  protected final String TEXT_364 = "+\" (";
  protected final String TEXT_365 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_366 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_367 = " =  conn_";
  protected final String TEXT_368 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_369 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_370 = " = \"";
  protected final String TEXT_371 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_372 = " =  \"";
  protected final String TEXT_373 = "\";" + NL + "    int rowCount";
  protected final String TEXT_374 = " = 0;";
  protected final String TEXT_375 = NL + "        StringBuffer query_";
  protected final String TEXT_376 = " = null;" + NL + "       \t";
  protected final String TEXT_377 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_378 = " = insert_";
  protected final String TEXT_379 = ".split(\"\\\\?\");";
  protected final String TEXT_380 = NL + "\t\t\tupdate_";
  protected final String TEXT_381 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_382 = " = update_";
  protected final String TEXT_383 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_384 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_388 = NL + "\t\t\treplace_";
  protected final String TEXT_389 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_390 = " = replace_";
  protected final String TEXT_391 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_392 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_393 = " = insertIgnore_";
  protected final String TEXT_394 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_395 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_396 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_397 = "\") == true;";
  protected final String TEXT_398 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_399 = ".createStatement();";
  protected final String TEXT_400 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_401 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_402 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_403 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_404 = NL + "            stmt_";
  protected final String TEXT_405 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_406 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_407 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_408 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_409 = " =null;" + NL + "\t";
  protected final String TEXT_410 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_414 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_415 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_416 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_417 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_418 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
