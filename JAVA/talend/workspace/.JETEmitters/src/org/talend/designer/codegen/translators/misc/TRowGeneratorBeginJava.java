...
public class TRowGeneratorBeginJava
{
  ...
  protected final String TEXT_25 = "Randomizer rand";
  protected final String TEXT_26 = " = new ";
  protected final String TEXT_27 = "Randomizer();" + NL + "\t";
  protected final String TEXT_28 = NL + "    \tlog.info(\"";
  protected final String TEXT_29 = " - Generating records.\");";
  protected final String TEXT_30 = NL + "\tfor (int i";
  protected final String TEXT_31 = "=0; i";
  protected final String TEXT_32 = "<nb_max_row_";
  protected final String TEXT_33 = " ;i";
  protected final String TEXT_34 = "++) {";
  protected final String TEXT_35 = ".";
  protected final String TEXT_36 = " = rand";
  protected final String TEXT_37 = ".getRandom";
  protected final String TEXT_38 = "();";
  protected final String TEXT_39 = NL + "\t\tnb_line_";
  protected final String TEXT_40 = "++;" + NL + "\t\t";
  protected final String TEXT_41 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_42 = " - Retrieving the record \" + nb_line_";
