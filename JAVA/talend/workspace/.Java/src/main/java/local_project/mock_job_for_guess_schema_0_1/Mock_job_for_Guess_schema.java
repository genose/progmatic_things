	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:jtds:sqlserver://STA7400535:1433/SDBM;";
				java.sql.Connection conn = java.sql.DriverManager.getConnection(url, "sa", "afpa");
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery("select * from article");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/Users/59013-36-18/Desktop/Talend/TOS_DI-20190620_1446-V7.2.1/temp/TempGuessSchemaDelimitedFile.csv"))
...
/************************************************************************************************
 * 44077 characters generated by Talend Open Studio for Data Integration on the
 * 5 juillet 2019 à 09:12:59 CEST
 ************************************************************************************************/