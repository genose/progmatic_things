...
package local_project.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/59013-36-18/Desktop/Talend/TOS_DI-20190620_1446-V7.2.1/workspace/LOCAL_PROJECT/temp/preview/SDBM - Ventes.csv"))
				...
				String[] headColutFileOutputDelimited = new String[5];
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/Users/59013-36-18/Downloads/SDBM - Ventes.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/59013-36-18/Downloads/SDBM - Ventes.csv", "US-ASCII", ";", "\n", true, 0, 0,
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[5];
					...
					if (!((Object) ("C:/Users/59013-36-18/Downloads/SDBM - Ventes.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"local_project/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 43494 characters generated by Talend Open Studio for Data Integration on the
 * 5 juillet 2019 à 09:15:19 CEST
 ************************************************************************************************/